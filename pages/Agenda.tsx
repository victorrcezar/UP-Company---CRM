                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    ...
                    {isGoogleConnected ? (
                        ...
                        <button 
                            ...
                            className="px-5 py-2.5 bg-white dark:bg-up-deep border border-gray-200 dark:border-white/10 rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center gap-3 text-up-dark dark:text-white hover:border-blue-500 shadow-sm transition-all"
                        >
